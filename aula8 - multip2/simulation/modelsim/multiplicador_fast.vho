...
-- pronto	=>  Location: PIN_D15,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- saida[3]	=>  Location: PIN_G14,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- ConteudoA[0]	=>  Location: PIN_G13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- ConteudoA[3]	=>  Location: PIN_B15,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- ConteudoB[0]	=>  Location: PIN_C15,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- ConteudoB[1]	=>  Location: PIN_D14,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- ConteudoB[2]	=>  Location: PIN_H15,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- ConteudoB[3]	=>  Location: PIN_A14,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- entA[3]	=>  Location: PIN_E15,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- entB[0]	=>  Location: PIN_B17,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- entB[1]	=>  Location: PIN_C16,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- inicio	=>  Location: PIN_H16,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
SIGNAL \bo1|muxA|y[0]~0_combout\ : std_logic;
SIGNAL \bo1|muxA|y[1]~1_combout\ : std_logic;
SIGNAL \bo1|muxA|y[2]~2_combout\ : std_logic;
SIGNAL \bo1|muxA|y[2]~3_combout\ : std_logic;
...
-- Equation(s):
-- \bo1|geraBz|Equal0~0_combout\ = (!\bo1|regB|q\(2) & (!\bo1|regB|q\(0) & (!\bo1|regB|q\(1) & !\bo1|regB|q\(3))))
...
\bo1|muxA|y[0]~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \bo1|muxA|y[0]~0_combout\ = (\bc1|state.S1~regout\ & ((\entA~combout\(0)))) # (!\bc1|state.S1~regout\ & (!\bo1|regA|q\(0)))
...
PORT MAP (
	...
	combout => \bo1|muxA|y[0]~0_combout\);

-- Location: LCFF_X36_Y35_N29
\bo1|regA|q[0]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \bo1|muxA|y[0]~0_combout\,
	ena => \bc1|CP~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \bo1|regA|q\(0));
...
\bo1|muxA|y[1]~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \bo1|muxA|y[1]~1_combout\ = (\bc1|state.S1~regout\ & (\entA~combout\(1))) # (!\bc1|state.S1~regout\ & ((\bo1|regA|q\(1) $ (!\bo1|regA|q\(0)))))
...
PORT MAP (
	...
	datac => \bo1|regA|q\(1),
	datad => \bo1|regA|q\(0),
	combout => \bo1|muxA|y[1]~1_combout\);

-- Location: LCFF_X36_Y35_N15
\bo1|regA|q[1]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \bo1|muxA|y[1]~1_combout\,
	ena => \bc1|CP~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \bo1|regA|q\(1));
...
-- Equation(s):
-- \bo1|muxA|y[2]~2_combout\ = (!\bc1|state.S1~regout\ & (\bo1|regA|q\(2) $ (((!\bo1|regA|q\(0) & !\bo1|regA|q\(1))))))
...
\bo1|muxA|y[2]~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \bo1|muxA|y[2]~3_combout\ = (\bo1|muxA|y[2]~2_combout\) # ((\bc1|state.S1~regout\ & \entA~combout\(2)))
...
PORT MAP (
	...
	datad => \bo1|muxA|y[2]~2_combout\,
	combout => \bo1|muxA|y[2]~3_combout\);

-- Location: LCFF_X36_Y35_N1
\bo1|regA|q[2]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	datain => \bo1|muxA|y[2]~3_combout\,
	ena => \bc1|CP~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \bo1|regA|q\(2));
...
-- Equation(s):
-- \bo1|geraAz|Equal0~0_combout\ = (!\bo1|regA|q\(0) & (!\bo1|regA|q\(1) & !\bo1|regA|q\(2)))
